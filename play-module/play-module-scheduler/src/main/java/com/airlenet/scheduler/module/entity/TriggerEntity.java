package com.airlenet.scheduler.module.entity;
...
import com.airlenet.scheduler.support.SerializeJobDataConverter;
...
public class TriggerEntity extends AbstractPersistable<TriggerPrimaryKey> {
	...
	@Convert(converter = SerializeJobDataConverter.class)
