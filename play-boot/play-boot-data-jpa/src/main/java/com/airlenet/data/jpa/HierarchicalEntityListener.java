...
public class HierarchicalEntityListener {
	 ...
	 */
	@PrePersist
	public <U extends Userable, I extends Serializable, T> void prePersist(HierarchicalEntity<U, I, T> entity) {
	 ...
	 */
	@PreUpdate
	public <U extends Userable, I extends Serializable, T> void preUpdate(HierarchicalEntity<U, I, T> entity) {
		@SuppressWarnings("unchecked")
		HierarchicalEntity<U, I, T> parent = (HierarchicalEntity<U, I, T>) entity.getParent();
		if (parent != null) {
			entity.setTreePath(parent.getTreePath() + parent.getId() + TREE_PATH_SEPARATOR);
