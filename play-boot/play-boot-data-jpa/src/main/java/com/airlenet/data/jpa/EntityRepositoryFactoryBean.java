	...
	private static class CustomRepositoryFactory<T, I extends Serializable> extends JpaRepositoryFactory {
		...
		protected Object getTargetRepository(RepositoryInformation information) {
			return isBaseJpaRepository(information.getRepositoryInterface()) ? (isHierarchicalJpaRepository(information.getRepositoryInterface())
					? new HierarchicalEntityRepositoryImpl(getEntityInformation(information.getDomainType()), entityManager)
					: new EntityRepositoryImpl<>(getEntityInformation(information.getDomainType()), entityManager))
