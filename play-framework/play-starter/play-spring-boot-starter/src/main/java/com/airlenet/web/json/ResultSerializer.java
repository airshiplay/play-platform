...
public class ResultSerializer extends JsonSerializer<RestResult> {
	...
	@Override
	public void serialize(RestResult value, JsonGenerator gen, SerializerProvider serializers)
		...
		gen.writeBooleanField(FIELD_SUCCESS, Objects.equal(value.getCode(), RestResult.ResultCode.success));
		gen.writeStringField(FIELD_CODE, value.getCode());
		if (Objects.equal(RestResult.ResultCode.validateError, value.getCode())) {
		...
		if (Objects.equal(value.getCode(), RestResult.ResultCode.validateError)) {
