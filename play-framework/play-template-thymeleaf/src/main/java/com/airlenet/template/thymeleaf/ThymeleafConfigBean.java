package com.airlenet.template.thymeleaf;
...
import com.airlenet.config.ConfigWrapper;
import com.airlenet.config.StaticConfigSupplier;
import com.airlenet.core.PlayConstants;
import com.airlenet.template.thymeleaf.dialect.PlayStandardDialect;
...
public class ThymeleafConfigBean {
	...
	public SpringTemplateEngine templateEngine() {
		...
		templateEngine.setTemplateResolver(templateResolver());
		 templateEngine.addDialect(new PlayStandardDialect(messageSourceAccessor));
