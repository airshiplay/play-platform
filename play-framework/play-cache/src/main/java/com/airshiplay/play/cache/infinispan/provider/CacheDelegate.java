package com.airshiplay.play.cache.infinispan.provider;
...
/**
 * Since there are 2 Cache implementation with exactly the same implementation
 * details - is it convenient to introduce common abstraction and delegate all
 * the methods. This is exactly what happens here.
 *
