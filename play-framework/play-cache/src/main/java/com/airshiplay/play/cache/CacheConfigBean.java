package com.airshiplay.play.cache;
...
import com.airshiplay.play.cache.infinispan.provider.SpringEmbeddedCacheManagerFactoryBean;

@Configuration
@EnableCaching
public class CacheConfigBean implements CachingConfigurer {

	public static final String INFINISPAN_CONFIG = "/com/airshiplay/play/cache/infinispan/infinispan.xml";
