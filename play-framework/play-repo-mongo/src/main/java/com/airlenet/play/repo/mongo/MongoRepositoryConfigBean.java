...
import com.airlenet.play.repo.domain.DatabaseResolver;
import com.airlenet.play.repo.domain.NullDatabaseResolver;

@Configuration
@EnableMongoRepositories(basePackages = { "com.airlenet" }, includeFilters = {
