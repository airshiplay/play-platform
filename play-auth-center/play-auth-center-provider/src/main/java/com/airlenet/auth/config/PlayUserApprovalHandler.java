...
public class PlayUserApprovalHandler  extends ApprovalStoreUserApprovalHandler {
    ...
    public PlayUserApprovalHandler(JdbcClientDetailsService clientDetailsService, ApprovalStore approvalStore, OAuth2RequestFactory oAuth2RequestFactory) {
