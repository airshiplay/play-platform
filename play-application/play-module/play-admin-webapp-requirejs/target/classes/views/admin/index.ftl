...
<link rel="stylesheet" href="requirejs/app/assets/vendor/bootstrapvalidator/css/bootstrapValidator.min.css">
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="requirejs/app/assets/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="requirejs/app/assets/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
		  ...
		  <li class="treeview">
            	...
            	<span>${menuTree.text}</span>
          		...
          		<#list menuTree.children as menu>
            		<li><a href="#${menu.data.view}"><i class="${menu.iconCls}"></i>${menu.text}</a></li>
          		</#list>
          		</ul>
    		</li>
		</#list>
...
<!-- REQUIRED JS SCRIPTS -->
	...
	<script data-main="/" src="/requirejs/app/assets/vendor/requirejs/require.js"></script>
	...
	<script type="text/javascript">
		...
		requirejs.config({
			paths : {
				...
				bootgrid : base + "/requirejs/app/assets/vendor/jquery.bootgrid/jquery.bootgrid",
				...
				validator : "/requirejs/app/assets/vendor/bootstrapvalidator/js/bootstrapValidator.min",
				validatorzh : "/requirejs/app/assets/vendor/bootstrapvalidator/js/language/zh_CN",
