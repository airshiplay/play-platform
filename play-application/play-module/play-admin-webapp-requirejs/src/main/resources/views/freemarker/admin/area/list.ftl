		...
		<div class="col-xs-12">
			<div class="mailbox-controls">
				<div class="btn-group btn-group-sm">
					<a type="button" class="btn btn-primary" href="#/page/center/area/add">
					...
					<table id="grid-app" class="table table-hover">
						<thead>
							<tr>
								...
								<th data-column-id="type" data-formatter="type" >等级</th>
...
<script type="text/javascript">
	require(
			...
			function(domReady) {
				domReady(function() {
					activeMenu("center_area_management");

					var grid = $("#grid-app")
							.bootgrid(
									{
										url : base + "/center/area/page",
										formatters : {
