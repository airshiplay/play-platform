					...
					<div class="box-body">
						<div class="form-group">
							...
							<input type="text" name="name" class="form-control" id="nameInput" placeholder="请填写角色名" data-bv-notempty="true"
								data-bv-notempty-message="请填写角色名" value="${role.name}">
						</div>
						<div class="form-group">
							<label for="codeInput">标识</label>
							<input type="text" name="code" class="form-control" id="codeInput" placeholder="请填写昵称" data-bv-notempty="true" data-bv-notempty-message="请填写昵称" value="${role.code}">
						</div>
					</div>
					<!-- /.box-body -->
