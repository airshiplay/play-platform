					...
					<table id="grid-app" class="table table-hover">
						<thead>
							<tr>
								...
								<th data-column-id="type" data-formatter="type" >终端</th>
								<th data-column-id="level" data-sortable="false" >等级</th>
								<th data-column-id="ip">IP</th>
								<th data-column-id="text" data-formatter="text">日志</th>
							...
							.bootgrid(
									{
										...
										formatters : {
											...
											"text":function(column,row){
												return row.text.substring(0,100)+"...";
											},
