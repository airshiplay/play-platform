...
<link type="text/css" rel="stylesheet" href="//cdn.bootcss.com/jstree/3.3.2/themes/default/style.min.css">
		...
		<div class="col-md-8">
			<div class="mailbox-controls">
				<div class="btn-group btn-group-sm">
					<a type="button" class="btn btn-primary" href="#/page/center/org/add">
