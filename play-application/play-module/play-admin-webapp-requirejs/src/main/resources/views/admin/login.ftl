...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="${base}/requirejs/app/assets/plugins/iCheck/square/blue.css">
...
<!-- Bootstrap 3.3.6 -->
<script src="${base}/requirejs/app/assets/bootstrap/js/bootstrap.min.js"></script>
<!-- Bootstrap 3.3.6 
	<script src="//cdn.bootcss.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>-->
	
	
	<script type="text/javascript" src="${base}/requirejs/app/assets/vendor/bootstrapvalidator/js/bootstrapValidator.min.js"></script>
	<script type="text/javascript" src="${base}/requirejs/app/assets/vendor/bootstrapvalidator/js/language/zh_CN.js"></script>
	<!-- iCheck -->
	<script src="//cdn.bootcss.com/iCheck/1.0.2/icheck.min.js"></script>
<!-- iCheck 
<script src="${base}/requirejs/app/assets/plugins/iCheck/icheck.min.js"></script>-->
<script>
  $(function () {
    $('input').iCheck({
