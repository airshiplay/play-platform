				...
				domReady(function() {
							...
							.bootgrid(
									{
										...
										formatters : {
											"logo":function(cloumn,row){
												 return "<img src=\""+row.logo+"\" width=\"30\" height=\"30\" \/>";
											},
											...
											"commands" : function(column, row) {
												...
												var line=
													"\
													<div class=\"btn-group btn-group-sm\" data-row-id=\""+row.id+"\"  data-install-url=\""+row.installUrl+"\">\
														...
														if(row.isInstalled){
															line =line+"<li><a href=\"javascript:;\" class=\"command-delete\"><i class=\"glyphicon glyphicon-remove\"></i>移除</a></li>";
														}else{
															line =line+"<li><a href=\"javascript:;\" class=\"command-installApplication\"><i class=\"glyphicon glyphicon-send\"></i>安装</a></li>";
														}
														line =line +"</ul>";			
					...
					grid.on("loaded.rs.jquery.bootgrid", function() {
						...
						$table.find(".command-installApplication").on("click", function() {
							...
							var url = $(this).closest(".btn-group").data("install-url");
							installToDevice($table, [ app_id,url ]);
						});
