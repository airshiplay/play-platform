		...
		<div class="col-xs-12">
			<div class="mailbox-controls">
				<div class="btn-group btn-group-sm">
					<a type="button" class="btn btn-primary" href="#/page/cms/article/create">
					...
					<table id="grid-app" class="table table-hover">
						<thead>
							<tr>
								...
								<th data-column-id="title" data-sortable="false" >标题</th>
								<th data-column-id="publication" data-sortable="true" >发布</th>
								<th data-column-id="stick" data-sortable="true" >置顶</th>
				...
				domReady(function() {
					...
					var deleteRow = function(grid, ids) {
						...
						$.confirm({
							...
							animation : 'zoom',
							confirm : function() {
								$.post(base + "/cms/article/delete", $.param({
									"ids" : ids
								},true), function(resp) {
									if (resp.success) {
										$.alert({
