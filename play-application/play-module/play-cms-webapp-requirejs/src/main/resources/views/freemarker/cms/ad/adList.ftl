		...
		<div class="col-xs-12">
			<div class="mailbox-controls">
				<div class="btn-group btn-group-sm">
					<a type="button" class="btn btn-primary" href="#/page/cms/ad/create">
					...
					<table id="grid-app" class="table table-hover">
						<thead>
							<tr>
								...
								<th data-column-id="title" data-sortable="false" >名称</th>
								<th data-column-id="adPosition" data-formatter="adPosition">位置</th>
			...
			function(domReady) {
				domReady(function() {
					...
					var grid = $("#grid-app")
							.bootgrid(
									{
										url : base + "/cms/ad/page",
										formatters : {
											"adPosition":function(column,row){
