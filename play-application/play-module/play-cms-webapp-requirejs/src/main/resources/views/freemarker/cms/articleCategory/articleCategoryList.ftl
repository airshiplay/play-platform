		...
		<div class="col-xs-12">
			<div class="mailbox-controls">
				<div class="btn-group btn-group-sm">
					<a type="button" class="btn btn-primary" href="#/page/cms/articleCategory/create">
					...
					<table id="grid-app" class="table table-hover">
						<thead>
							<tr>
								...
								<th data-column-id="sortNo" data-sortable="true" >排序号</th>
...
<script type="text/javascript">
	require(
			...
			function(domReady) {
				domReady(function() {
					activeMenu("cms_articleCategory_list");
