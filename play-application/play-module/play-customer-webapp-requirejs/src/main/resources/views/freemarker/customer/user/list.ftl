...
<section class="content-header">
	<h1>
		用户列表 <small>开始管理业务用户</small>
	</h1>
	<ol class="breadcrumb">
		<li><a href="#page/home"><i class="fa fa-home"></i> Home</a></li>
		<li class="active"><a href="#page/customer/user/list"> 用户管理</a></li>
	</ol>
</section>
		...
		<div class="col-xs-12">
			<div class="mailbox-controls">
				<div class="btn-group btn-group-sm">
					<a type="button" class="btn btn-primary" href="#/page/center/user/add">
			...
			<div class="box box-primary">
				<div class="box-body no-padding">
					<table id="grid-app" class="table table-hover table-bordered">
						<thead>
							<tr>
								...
								<th data-formatter="status">状态</th>
				...
				domReady(function() {
					...
					var grid = $("#grid-app")
							.bootgrid(
								...
								<div class=\"btn-group btn-group-sm\" data-row-id=\""+row.id+"\">\
									<a type=\"button\" class=\"btn btn-primary\" href=\"#/page/center/user/edit/"+row.id+"\">\
					...
					var deleteRow = function(grid, ids) {
						$.confirm({
							...
							animation : 'zoom',
							confirm : function() {
								$.post(base + "/customer/user/delete", {
									ids : ids
								}, function(resp) {
									if (resp.success) {
										$.alert({
