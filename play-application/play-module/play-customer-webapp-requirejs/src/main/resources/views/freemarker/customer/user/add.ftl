...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li><a href="#/page/customer/user/list">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="box box-primary">
				...
				<!-- /.box-header -->
				<!-- form start -->
				<form role="form" class="book-form" action="/customer/user/save">
					...
					<div class="box-footer">
						<button type="button" class="btn btn-default" onclick="location.href='#/page/customer/user/list'">返回列表</button>
				...
				$.post($form.attr('action'), $form.serialize(), function(result) {
					if (result.success) {
						$.alert({
							...
							confirmButton : "返回列表",
							confirm : function() {
								location.href = "#/page/customer/user/list";
							}
						});
