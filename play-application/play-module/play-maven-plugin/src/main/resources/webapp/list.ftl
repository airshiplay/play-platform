...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">${functionShowName}管理</li>
	</ol>
</section>
		...
		<div class="col-xs-12">
			<div class="mailbox-controls">
				<div class="btn-group btn-group-sm">
					<a type="button" class="btn btn-primary" href="#/page/${moduleName}/${'${shortSimpleName}'?uncap_first}/create">
			...
			<div class="box box-primary">
				<div class="box-body no-padding">
					<table id="grid-${'${shortSimpleName}'?lower_case}" class="table table-hover">
						<thead>
							<tr>
								<th data-column-id="id" data-type="numeric" data-identifier="true" data-visible="false">ID</th>
								<#list fields as field>
								<th <#if field.formtype?exists&&field.formtype=='image'>data-formatter="icon" </#if> <#if field.fieldType=='Date'>data-column-id="${field.fieldName}" data-type="date" <#else>data-column-id="${field.fieldName}" </#if>data-sortable="false" >${field.fieldShowName!''}</th>
								</#list>
	...
	require(
			...
			function(domReady) {
				domReady(function() {
					...
					var grid = $("#grid-${'${shortSimpleName}'?lower_case}")
							.bootgrid(
									{
										url : base + "/${moduleName}/${'${shortSimpleName}'?uncap_first}/page",
										formatters : {
								...
								<div class=\"btn-group btn-group-sm\" data-row-id=\""+row.id+"\">\
									<a type=\"button\" class=\"btn btn-primary\" href=\"#/page/${moduleName}/${'${shortSimpleName}'?uncap_first}/view/"+row.id+"\">\
										<i class=\"fa fa-eye\"></i>\
									</a>\
									<a type=\"button\" class=\"btn btn-primary\" href=\"#/page/${moduleName}/${'${shortSimpleName}'?uncap_first}/edit/"+row.id+"\">\
