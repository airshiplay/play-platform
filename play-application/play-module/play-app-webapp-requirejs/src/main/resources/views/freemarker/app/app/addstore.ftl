		...
		<div class="col-xs-12">
			...
			<div class="box box-primary">
				...
				<form role="form" class="app-form" action="/app/app/save">
					...
					<input type="hidden" name="fileSizeBytes" value="" />
					<div class="box-body">
						
						<div class="form-group">
							<label for="nameInput">TrackID</label>
							<div class="input-group">
								<input type="text" class="form-control" placeholder="请输入或点击搜索选择" name="trackId" value="" data-bv-notempty="true"
									data-bv-notempty-message="请填写TrackID" data-bv-integer="true" data-bv-integer-message="请输入整数">
						...
						<div class="form-group">
							...
							<input type="text" name="name" class="form-control" id="nameInput" placeholder="请填写应用名称" data-bv-notempty="true"
								data-bv-notempty-message="请填写应用名称" value="">
						</div>
						<div class="form-group">
							<label for="iconInput">应用图标</label>
							<div class="kv-avatar">
								<input type="hidden" name="iconPath" value="" />
						...
						<div class="form-group">
							...
							<input type="text" name="platform" class="form-control" id="platformInput" placeholder="根据应用文件自动获取" readOnly value="">
						</div>
						<div class="form-group">
							<label for="identifierInput">应用标识</label>
							<input type="text" name="identifier" class="form-control" id="identifierInput" placeholder="根据应用文件自动获取" data-bv-notempty="true"
								data-bv-notempty-message="请上传应用文件" value="">
						</div>
						<div class="form-group">
							<label for="versionInput">应用版本</label>
							<input type="text" name="version" class="form-control" id="versionInput" placeholder="根据应用文件自动获取" readOnly value="">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<textarea name="description" class="form-control" id="descriptionInput" rows="10"></textarea>
						</div>
					</div>
					<!-- /.box-body -->

					<div class="box-footer">
						<button type="button" class="btn btn-default" onclick="location.href='#/page/app/app/list'">返回列表</button>
...
<script type="text/javascript">
	require([ "domReady", "fileinputzh" ], function(domReady) {
		domReady(function() {
			...
			$fileInput.fileinput({
				language : "zh",
				uploadUrl : base + "/app/app/upload_app_file", // server upload action
			...
			$("#chooseStoreAppButton").on("click", function() {
				$.confirm({
					title : "搜索store上的应用",
					content : "url:" + base + "/app/app/dialog/storeAppList",
