		...
		<div class="col-xs-12">
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">新增企业应用</h3>
				</div>
				<!-- /.box-header -->
				<!-- form start -->
				<form role="form" class="app-form" action="/center/app/save">
					...
					<div class="box-body">
						<div class="form-group">
							<label for="fileInput">应用文件</label>
							<input type="file" id="fileInput" class="file-loading" name="app_file">
							<p class="help-block">请上传后缀为.ipa的文件，下面部分信息会根据应用文件所得。</p>
						</div>
					...
					<div class="box-footer">
						<button type="button" class="btn btn-default" onclick="location.href='#/page/app'">返回列表</button>
