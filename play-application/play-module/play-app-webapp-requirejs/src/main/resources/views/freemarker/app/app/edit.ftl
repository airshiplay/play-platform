					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="input-group">
								<input type="text" class="form-control" placeholder="请输入或点击搜索选择" name="trackId" value="${app.trackId}" data-bv-notempty="true"
						...
						<div class="form-group">
							...
							<input type="text" name="platform" class="form-control" id="platformInput" placeholder="根据应用文件自动获取" readOnly value="ios">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" name="version" class="form-control" id="versionInput" placeholder="根据应用文件自动获取" readOnly value="${app.version}">
						</div>
						<div class="form-group">
							<label for="imageInput">应用图片</label>
							<input type="hidden" name="photos" value="<#list app.photos as photo><#if photo_index==0>${photo}<#else>,${photo}</#if></#list>" />
						...
						<div class="form-group">
							...
							<textarea name="description" class="form-control" id="descriptionInput" rows="10">${app.description}</textarea>
						</div>
					</div>
					<!-- /.box-body -->
