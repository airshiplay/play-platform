...
public class BusinessTemplate {
	...
	public static void main(String[] args) throws TemplateException, IOException {
		...
		for(Class<?>cls:new Class[]{ObdMemberRankEntity.class,ObdDeviceEntity.class,OrderEntity.class,ReserveEntity.class,VehicleAlarmEntity.class,VehicleEntity.class}){
			repo(cfg, cls);
			service(cfg, cls);
		}
