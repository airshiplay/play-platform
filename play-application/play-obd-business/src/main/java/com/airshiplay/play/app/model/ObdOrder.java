...
/**
 *
 * database table obd_order
 *
 * @date do_not_delete_during_merge
 */
public class ObdOrder implements Serializable {
    private Long id;
     ...
     * This field corresponds to the database table obd_order
     *
     * @date
     */
