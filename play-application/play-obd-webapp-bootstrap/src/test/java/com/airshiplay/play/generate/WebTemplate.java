package com.airshiplay.play.generate;
...
public class WebTemplate {
	...
	public static void main(String[] args) throws TemplateException, IOException {
		...
		for (Class<?> cls : new Class[] {ActivityEntity.class,ObdMemberRankEntity.class, Store4SEntity.class, ObdDeviceEntity.class, OrderEntity.class, ReserveEntity.class, VehicleAlarmEntity.class, VehicleEntity.class }) {
			controller(cfg, cls);
			htmlList(cfg, cls);
			htmlForm(cfg, cls);
			htmlView(cfg, cls);
