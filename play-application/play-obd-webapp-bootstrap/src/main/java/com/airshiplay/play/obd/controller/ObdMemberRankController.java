...
import com.airshiplay.play.obd.service.ObdMemberRankEntityService;
import com.airshiplay.play.repo.domain.Result;
import com.querydsl.core.types.Predicate;

@Controller
@RequestMapping("/obd/memberRank")
public class ObdMemberRankController {

	@Autowired
	private ObdMemberRankEntityService memberRankEntityService;
	...
	@ResponseBody
	public Page<ObdMemberRankEntity> doPage(Predicate predicate, Pageable pageable) {
		return memberRankEntityService.findAll(predicate, pageable);
	}

	@RequestMapping(value = "/save", method = RequestMethod.POST)
	@ResponseBody
	public Result doSave(@ModelAttribute @Valid ObdMemberRankEntity job, BindingResult bindingResult) {
	...
	@ResponseBody
	public Result delete(@RequestParam(value = "id") ObdMemberRankEntity entity) {
	...
	@ResponseBody
	public Result batchDelete(@RequestParam(value = "ids") ObdMemberRankEntity[] entities) {
		for (ObdMemberRankEntity entity : entities) {
			memberRankEntityService.delete(entity);
		}
