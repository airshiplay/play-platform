...
public interface WexinUserApi {
	...
	@GET("user/get")
	@Headers("access_token: 0")
	public Call<WexinUserListResp> getUserList(
	...
	@GET("user/info")
	@Headers("access_token: 0")
	public Call<WexinUserInfoResp> getUserInfo(@Query("openid") String openid,
	...
	@Headers("access_token: 0")
	public Call<WexinUserInfoBatchResp> getUserInfoBatch(
			@Body WexinUserInfoBatchReq req);
